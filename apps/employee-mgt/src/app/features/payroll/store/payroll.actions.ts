...
// Action Creators
export const loadPayrollData = (): PayrollAction => ({ type: 'LOAD_PAYROLL_DATA' });
...
export const exportPayrollData = (): PayrollAction => ({ type: 'EXPORT_PAYROLL_DATA' });
...
export const setPayrollError = (error: string | null): PayrollAction => ({
  type: 'SET_PAYROLL_ERROR',
  payload: error
});

export const resetPayrollState = (): PayrollAction => ({ type: 'RESET_PAYROLL_STATE' });
